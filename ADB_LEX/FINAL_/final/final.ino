...
#define inr1 8
#define inr2 9
// #define OCTAVIAN_INTRERUPERE() attachInterrupt();
/////////////////////////////
/*
   ---------------------------------------------------------------------------------------------------------
*/
...
#define AVOID_OBSTACLE_STOP_BEFORE_OBSTACLE 28

#define START_PARKING 29
#define PARING_MODE_DETECTION 30
#define PARING_MODE_SART_OBSTACLE_FOUND 31
#define PARING_MODE_SART_OBSTACLE_NOT_FOUND 32
#define START_PARKING_SKANNING 33
#define PARKING_IN_SCANNING 34
#define SCANNING_DONE 35
/*
   ---------------------------------------------------------------------------------------------------------
*/
////////////////////////////////////////////////////////////////////////////////////////////TIMP_AVOID_OBSTACLE///////////////////////////////////////////////////////////////
...
#define TIME_STOP_INAINTE_OBSTACOL 52
////////////////////////////////////////////////////////////////////////////////////////////TIMP_AVOID_OBSTACLE///////////////////////////////////////////////////////////////

////////////////////////////////////////////////////////////////////////////////////////////TIMP_PARKING///////////////////////////////////////////////////////////////
#define PARKING_LARGIME_PARKARE_ULTRASONIC_SENSORS 80 //cm largimea masinii
#define PARKING_MERGI_INAINTE_TIME 1000               //gasire loc suficient inainte
// #define TIME_STOP_INAINTE_OBSTACOL 180
////////////////////////////////////////////////////////////////////////////////////////////TIMP_PARKING///////////////////////////////////////////////////////////////
...
#define SCANING_DONE_RIGHT_TIME 1000 //0.5 secunde
#define SCANING_DONE_LEFT_TIME 500   //0.5 secunde
#define SCANING_DONE_CENTER_TIME 500 //0.5 secunde
...
void carDrive(void)
{
  ...
  case AVOID_OBSTACLE_FIND_OBTSACLE_STATE: //================ //2
    if (vsonic_1_front < DISTANCE_BREAK_VALUE or vsonic_2_front < DISTANCE_BREAK_VALUE or vsonic_3_front < DISTANCE_BREAK_VALUE or vsonic_4_front < DISTANCE_BREAK_VALUE or vsonic_5_front < DISTANCE_BREAK_VALUE)
    {
      car_state = AVOID_OBSTACLE_FIND_OBTSACLE_STATE;
      int var = 0;
      while (var < TIME_STOP_INAINTE_OBSTACOL)
      {
        CarReverse(150);
        var++;
      }
    ...
    else
    {
      ...
      if (vsonic_1_front < 80 or vsonic_2_front < 80 or vsonic_3_front < 80 or vsonic_4_front < 80 or vsonic_5_front < 80)
      {
        ...
        car_state = AVOID_OBSTACLE_STOP_BEFORE_OBSTACLE;
      }
    }
    break;

  case AVOID_OBSTACLE_STOP_BEFORE_OBSTACLE:
    if (millis() - timeLastTransition_volan_front >= TIME_STOP_INAINTE_OBSTACOL) //==============================TREBUIE DE IMPARTIT LA 2==============//experimentat prima cotire
    {
      int var = 0;
      while (var < TIME_STOP_INAINTE_OBSTACOL)
      {
  ...
  case START_PARKING:
    if (vsonic_1_front < DISTANCE_BREAK_VALUE or vsonic_2_front < DISTANCE_BREAK_VALUE or vsonic_3_front < DISTANCE_BREAK_VALUE or vsonic_4_front < DISTANCE_BREAK_VALUE or vsonic_5_front < DISTANCE_BREAK_VALUE)
    {
      ...
      car_state = START_PARKING;
    }
    else
    {
      CarDrive(CRUISE_POWER - 20);
      if (vsonic_5_front > PARKING_LARGIME_PARKARE_ULTRASONIC_SENSORS)
      {
        car_state = PARING_MODE_SART_OBSTACLE_NOT_FOUND;
      }
      else if (vsonic_5_front < PARKING_LARGIME_PARKARE_ULTRASONIC_SENSORS - 10)
      {
        car_state = PARING_MODE_SART_OBSTACLE_FOUND;
      }
    }

    break;

  case PARING_MODE_SART_OBSTACLE_NOT_FOUND:
    CarDrive(CRUISE_POWER - 20);

    timeLastTransition_volan_front = millis();
    car_state = START_PARKING_SKANNING;
    break;

  case PARING_MODE_SART_OBSTACLE_FOUND: //a gasit locul unde se termina obstacolul
    CarDrive(CRUISE_POWER - 20);
    if (vsonic_5_front > PARKING_LARGIME_PARKARE_ULTRASONIC_SENSORS - 10)
    {
      timeLastTransition_volan_front = millis();
      car_state = START_PARKING_SKANNING;
    }
  ...
  case START_PARKING_SKANNING:
    CarDrive(CRUISE_POWER - 20);
    if (vsonic_5_front < PARKING_LARGIME_PARKARE_ULTRASONIC_SENSORS - 40)
    {
    ...
    {
      timeLastTransition_volan_front = millis();
      car_state = PARKING_IN_SCANNING;
    }

    break;
  case PARKING_IN_SCANNING:

    if (millis() - timeLastTransition_volan_front >= PARKING_MERGI_INAINTE_TIME) //========timup cat ii trebuie pentru a gasi un loc pentru parcare
    {
      CarTStop();

      car_state = SCANNING_DONE;
    }
    else
    {
      if (vsonic_5_front < PARKING_LARGIME_PARKARE_ULTRASONIC_SENSORS - 10)
      {
        CarReverse(CRUISE_POWER - 20);
        int reverse_time_delay = millis() - timeLastTransition_volan_front;
        int i = 0;
        while (i < reverse_time_delay)
        {
          i++;
        }
        CarStop();
    ...
    break;
  case SCANNING_DONE: //toate timingurile parcarii
    CarReverse(180);
    CarTRight_ALGO(250);
    int i;
    int time_volan = turn_volan_time / 2;
    Serial.println("1");
    while (i < SCANING_DONE_RIGHT_TIME)
    {
      i++;
    }
    Serial.println("2");
    i = 0;
    CarTLeft(250);
    while (i < SCANING_DONE_LEFT_TIME)
    {
      i++;
    }
    Serial.println("3");
